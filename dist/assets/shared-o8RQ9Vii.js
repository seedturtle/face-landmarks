import{ch as ct,A as ue,gx as S,ci as it,d2 as C,es as D,e3 as _,eC as K,eX as z,x as fe,fa as O,ap as he,b9 as de,hd as pe,C as ge,ew as me,dZ as W,fi as nt,c as ut,cF as P,t as ft,e1 as R,v as ht,a6 as dt,a8 as pt,aa as gt,ae as mt,af as It,am as wt,an as xt,ay as kt,az as bt,aB as yt,aM as Et,aP as St,aT as Rt,di as Ie,aU as we,aY as vt,b$ as xe,cY as ke,hk as be,b4 as ye,fM as Tt,e2 as Ee,e8 as Se,dM as Re,ed as ve,ea as Te,bm as Ne,hm as Me,cP as Pe,h9 as Ce,ga as Fe,cE as Ve,bn as Nt,bW as Y,bu as Mt,eP as De,cW as Ae,dY as Oe,by as qe,fN as Le,cl as $e,eg as ze,eh as We,ei as Ge,em as je,en as _e,ej as Be,el as Ke,ek as Ue,ep as st,eq as Ze,er as Xe,eo as Ye,bI as Pt,bK as Ct,bL as Ft,dD as X,dT as He,bR as Vt,g_ as L}from"./index--wnlGcJ8.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Dt(n){const e=new Float32Array(n.length);for(let t=0;t<n.length;++t)e[t]=Math.abs(n[t]);return e}const Je=n=>{const{x:e}=n.inputs,t=n.backend;A(e,"abs");let s=new Float32Array(S(e.shape));const o=t.data.get(e.dataId).values;return s=Dt(o),t.makeOutput(s,e.shape,e.dtype)},cs={kernelName:ue,backendName:"cpu",kernelFunc:Je};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function H(n,e,t="float32"){if(t==="complex64"){const o=H(n,e,"float32"),l=H(n,e,"float32");return U({inputs:{real:o,imag:l},backend:n})}const s=O(S(e),t);return n.makeTensorInfo(e,t,s)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function J(n){const{inputs:e,backend:t}=n,{x:s}=e;return t.incRef(s.dataId),{dataId:s.dataId,shape:s.shape,dtype:s.dtype}}const us={kernelName:he,backendName:"cpu",kernelFunc:J};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ot(n,e,t,s){if(s==="int32"){const o=Int32Array.from(n);return[e,"int32",o]}if(s==="bool"){const o=pe([0],t),[l,r]=v((c,a)=>c!==a?1:0)(e,[],n,o,"bool");return[r,"bool",l]}throw new Error(`Error in Cast: failed to cast ${t} to ${s}`)}function G(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dtype:l}=s;if(l==="complex64"){if(o.dtype==="complex64")return J({inputs:{x:o},backend:t});const f=H(t,o.shape,o.dtype),u=G({inputs:{x:o},backend:t,attrs:{dtype:"float32"}}),g=U({inputs:{real:u,imag:f},backend:t});return t.disposeIntermediateTensorInfo(f),t.disposeIntermediateTensorInfo(u),g}if(o.dtype==="complex64"){const f=At({inputs:{input:o},backend:t}),u=G({inputs:{x:f},backend:t,attrs:{dtype:l}});return t.disposeIntermediateTensorInfo(f),u}if(!me(o.dtype,l)){const f=J({inputs:{x:o},backend:t});return{dataId:f.dataId,shape:f.shape,dtype:l}}const r=t.data.get(o.dataId).values,[c,a,i]=Ot(r,o.shape,o.dtype,l);return t.makeTensorInfo(c,a,i)}const hs={kernelName:ge,backendName:"cpu",kernelFunc:G};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const qt=v((n,e)=>n+e),Qe=Q((n,e,t,s)=>({real:n+t,imag:e+s})),tn=T(ut,qt,Qe),ds={kernelName:ut,backendName:"cpu",kernelFunc:tn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $t(n,e,t){const s=F(e);return V(n,s,t)}function V(n,e,t){return({inputs:s,attrs:o,backend:l})=>{const{x:r}=s;A(r,n);const c=l,a=c.data.get(r.dataId).values;let i;if(r.dtype==="string"){if(!Array.isArray(a))throw new Error("String tensor's value was not an instance of Array");i=W(a)}else i=a;const f=t||r.dtype,u=e(i,f,o);return c.makeTensorInfo(r.shape,f,u)}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function an(n,e,t,s){const o=R(t,S(e));if(s&&t!=="string"){let l=0;n.forEach(r=>{const c=S(r.shape);o.set(r.vals,l),l+=c})}else{let l=0;n.forEach(r=>{const c=t==="string"?W(r.vals):r.vals;let a=0;for(let i=0;i<r.shape[0];++i){const f=i*e[1]+l;for(let u=0;u<r.shape[1];++u)o[f+u]=c[a++]}l+=r.shape[1]})}return o}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Wt=v((n,e)=>n===e?1:0),rn=T(dt,Wt,null,"bool"),ms={kernelName:dt,backendName:"cpu",kernelFunc:rn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gt=F(n=>Math.exp(n)),ln=V(pt,Gt,"float32"),Is={kernelName:pt,backendName:"cpu",kernelFunc:ln};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Yt=F(n=>Math.log(n)),xn=V(yt,Yt),Rs={kernelName:yt,backendName:"cpu",kernelFunc:xn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ht=v((n,e)=>Math.max(n,e)),bn=T(Et,Ht),vs={kernelName:Et,backendName:"cpu",kernelFunc:bn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jt=v((n,e)=>Math.min(n,e)),yn=T(St,Jt),Ts={kernelName:St,backendName:"cpu",kernelFunc:yn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const tt=v((n,e)=>n*e),En=Q((n,e,t,s)=>({real:n*t-e*s,imag:n*s+e*t})),Sn=T(Rt,tt,En),Ns={kernelName:Rt,backendName:"cpu",kernelFunc:Sn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(n,e,t){const s=Ie(-1,t);return tt([],e,s,n,t)}function Rn(n){const{inputs:e,backend:t}=n,{x:s}=e;A(s,"neg");const o=t.data.get(s.dataId).values,[l,r]=Qt(o,s.shape,s.dtype);return t.makeTensorInfo(r,s.dtype,l)}const Ms={kernelName:we,backendName:"cpu",kernelFunc:Rn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $n(n,e,t,s,o,l,r,c,a,i){const f=[s/o,o],u=n.values,g=e.values;if(s===0)return P(t,e.dtype);const m=a instanceof Y?a:P(f,e.dtype);typeof a=="string"||typeof a=="number"?m.values.fill(a):typeof a=="boolean"&&m.values.fill(+a);for(let d=0;d<l;d++){const w=[];let h=0;for(let p=0;p<r;p++){const I=u[d*r+p];w.push(I),h+=I*c[p]}if(h<0||h>=s/o)throw new Error(`Invalid indices: ${w} does not index into ${t}`);for(let p=0;p<o;p++)i?m.values[h*o+p]+=g[d*o+p]:m.values[h*o+p]=e.rank===0?g[0]:g[d*o+p]}return m}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zn=F(n=>1/(1+Math.exp(-n))),Wn=$t(Mt,n=>1/(1+Math.exp(-n))),Ds={kernelName:Mt,backendName:"cpu",kernelFunc:Wn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ae(n,e,t,s,o){const l=De(s,e,t),r=S(t),c=C(s);if(l){const u=Ae(e,c);return o==="string"?n.slice(u,u+r):n.subarray(u,u+r)}const a=o==="string"?W(n):n,i=P(s,o,a),f=P(t,o);for(let u=0;u<f.size;++u){const g=f.indexToLoc(u),m=g.map((d,w)=>d+e[w]);f.set(i.get(...m),...g)}return o==="string"?Oe(f.values):f.values}function Gn(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{begin:l,size:r}=s;A(o,"slice");const[c,a]=Le(o,l,r);$e(o,c,a);const i=t.data.get(o.dataId).values,f=ae(i,c,a,o.shape,o.dtype);return t.makeTensorInfo(a,o.dtype,f)}const As={kernelName:qe,backendName:"cpu",kernelFunc:Gn};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jn(n,e,t,s,o,l,r){const c=e[0],a=l[0],i=new Array(a),f=new Array(c),u=e[1];if(a===0){if(c!==0)throw new Error(ze(c));const h=R(t,0),p=R(o,0);return[h,[0,u],p,i,f]}let g=!0,m=0;const d=new Array(a).fill(0);for(let h=0;h<c;++h){const p=n[h*u];if(p<0)throw new Error(We(h,p));if(p>=a)throw new Error(Ge(h,p,a));++d[p],g=g&&p>=m,m=p}let w=!0;for(let h=0;h<a;++h){const p=d[h]===0;i[h]=p,w=w&&!p,d[h]=Math.max(d[h],1),h>0&&(d[h]+=d[h-1])}if(w&&g){const h=n,p=s;for(let I=0;I<c;++I)f[I]=I;return[h,[c,u],p,i,f]}else{const h=d[a-1],p=R(t,h*u),I=R(o,h),k=new Array(a).fill(0);for(let x=0;x<c;++x){const b=n[x*u],y=k[b],E=(b===0?0:d[b-1])+y;k[b]++;for(let N=0;N<u;++N)p[E*u+N]=n[x*u+N];I[E]=s[x],f[x]=E}for(let x=0;x<a;++x)if(k[x]===0){const y=x===0?0:d[x-1];p[y*u+0]=x;for(let E=1;E<u;++E)p[y*u+E]=0;I[y]=r}return[p,[h,u],I,i,f]}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const le=F((n,e)=>{const{pattern:t,replaceGlobal:s,rewrite:o}=e;return n.replace(new RegExp(t,s?"g":""),o)}),Xn=V(Ft,le),Ls={kernelName:Ft,backendName:"cpu",kernelFunc:Xn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yn(n,e,t,s){const o=P(n,e.dtype);for(let l=0;l<o.size;l++){const r=o.indexToLoc(l),c=new Array(r.length);for(let a=0;a<c.length;a++)c[a]=r[a]*t[a]+s[a];o.set(e.get(...c),...r)}return o}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Hn{constructor(e,t,s,o,l,r){this.separator=X(e),this.nGramWidths=t,this.leftPad=X(s),this.rightPad=X(o),this.padWidth=l,this.preserveShort=r}getPadWidth(e){return Math.min(this.padWidth<0?e-1:this.padWidth,e-1)}getNumNGrams(e,t){const s=this.getPadWidth(t);return Math.max(0,e+2*s-t+1)}createNGrams(e,t,s,o,l,r){for(let c=0;c<l;++c){const a=this.getPadWidth(r),i=Math.max(0,a-c),f=Math.max(0,a-(l-(c+1))),u=r-(i+f),g=t+(i>0?0:c-a);let m=0;m+=i*this.leftPad.length;for(let I=0;I<u;++I)m+=e[g+I].length;m+=f*this.rightPad.length;const d=i+f+u-1;m+=d*this.separator.length,s[o+c]=new Uint8Array(m);const w=s[o+c];let h=0;const p=I=>I.forEach(k=>w[h++]=k);for(let I=0;I<i;++I)p(this.leftPad),p(this.separator);for(let I=0;I<u-1;++I)p(e[g+I]),p(this.separator);if(u>0){p(e[g+u-1]);for(let I=0;I<f;++I)p(this.separator),p(this.rightPad)}else{for(let I=0;I<f-1;++I)p(this.rightPad),p(this.separator);p(this.rightPad)}}}compute(e,t){const s=e.length,o=t.length;if(o>0){let a=t[0];if(a!==0)throw new Error(`First split value must be 0, got ${a}`);for(let i=1;i<o;++i){let f=t[i]>=a;if(f=f&&t[i]<=s,!f)throw new Error(`Invalid split value ${t[i]}, must be in [${a}, ${s}]`);a=t[i]}if(a!==s)throw new Error(`Last split value must be data size. Expected ${s}, got ${a}`)}const l=o-1,r=R("int32",o);if(s===0||o===0){const a=new Array(s);for(let i=0;i<=l;++i)r[i]=0;return[a,r]}r[0]=0;for(let a=1;a<=l;++a){const i=t[a]-t[a-1];let f=0;this.nGramWidths.forEach(u=>{f+=this.getNumNGrams(i,u)}),this.preserveShort&&i>0&&f===0&&(f=1),r[a]=r[a-1]+f}const c=new Array(r[l]);for(let a=0;a<l;++a){const i=t[a];let f=r[a];if(this.nGramWidths.forEach(u=>{const g=t[a+1]-t[a],m=this.getNumNGrams(g,u);this.createNGrams(e,i,c,f,m,u),f+=m}),this.preserveShort&&f===r[a]){const u=t[a+1]-t[a];if(u===0)continue;const g=u+2*this.padWidth;this.createNGrams(e,i,c,f,1,g)}}return[c,r]}}function Jn(n,e,t,s,o,l,r,c){return new Hn(t,s,o,l,r,c).compute(n,e)}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function es(n,e){const t=R("int32",n.length);for(let s=0;s<n.length;++s)t[s]=He(n[s]).modulo(e).getLowBitsUnsigned();return t}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ce=v((n,e)=>n-e),ns=Q((n,e,t,s)=>({real:n-t,imag:e-s})),ss=T(Vt,ce,ns),$s={kernelName:Vt,backendName:"cpu",kernelFunc:ss};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function rs(n,e,t,s){const o=Tt(e,t)[0],l=[1,t[0],1];for(let d=0;d<o;d++)l[0]*=t[d];l[1]=t[o];for(let d=o+1;d<t.length;d++)l[2]*=t[d];const r=new Map,c=new Int32Array(t[o]),a=new Y(l,s,n),i=[],f=l[0]===1&&l[2]===1;for(let d=0;d<t[o];d++){let w;if(f)w=n[d].toString();else{const p=[];for(let I=0;I<l[0];I++)for(let k=0;k<l[2];k++)p.push(a.get(I,d,k));w=p.join(",")}const h=r.get(w);if(h!=null)c[d]=h;else{const p=r.size;r.set(w,p),c[d]=p,i.push(d)}}const u=l.slice();u[1]=r.size;const g=new Y(u,s);i.forEach((d,w)=>{for(let h=0;h<l[0];h++)for(let p=0;p<l[2];p++)g.set(a.get(h,d,p),h,w,p)});const m=t.slice();return m[o]=u[1],{outputValues:g.values,outputShape:m,indices:c}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zs=Object.freeze(Object.defineProperty({__proto__:null,addImpl:qt,bincountImpl:en,bincountReduceImpl:nn,bitwiseAndImpl:Lt,castImpl:Ot,ceilImpl:zt,concatImpl:an,equalImpl:Wt,expImpl:Gt,expm1Impl:jt,floorDivImpl:Bt,floorImpl:_t,gatherNdImpl:hn,gatherV2Impl:dn,greaterEqualImpl:Ut,greaterImpl:Kt,lessEqualImpl:Xt,lessImpl:Zt,linSpaceImpl:wn,logImpl:Yt,maxImpl:kn,maximumImpl:Ht,minimumImpl:Jt,multiplyImpl:tt,negImpl:Qt,notEqualImpl:te,prodImpl:se,raggedGatherImpl:Dn,raggedRangeImpl:An,raggedTensorToTensorImpl:On,rangeImpl:qn,rsqrtImpl:oe,scatterImpl:$n,sigmoidImpl:zn,simpleAbsImpl:Dt,sliceImpl:ae,sparseFillEmptyRowsImpl:jn,sparseReshapeImpl:_n,sparseSegmentReductionImpl:Bn,sqrtImpl:Kn,squaredDifferenceImpl:re,staticRegexReplaceImpl:le,stridedSliceImpl:Yn,stringNGramsImpl:Jn,stringSplitImpl:ts,stringToHashBucketFastImpl:es,subImpl:ce,tileImpl:os,topKImpl:as,transposeImpl:ee,uniqueImpl:rs},Symbol.toStringTag,{value:"Module"}));export{jn as $,J as A,us as B,Es as C,Ss as D,wn as E,Rs as F,kn as G,vs as H,Ts as I,Sn as J,Ns as K,Ms as L,Ps as M,Fs as N,Dn as O,An as P,On as Q,qn as R,At as S,fs as T,Vs as U,$n as V,zs as W,Wn as X,Ds as Y,Gn as Z,As as _,cs as a,_n as a0,Bn as a1,Os as a2,qs as a3,Ls as a4,Yn as a5,Jn as a6,ts as a7,es as a8,ss as a9,$s as aa,os as ab,as as ac,ne as ad,Cs as ae,ee as af,$t as ag,rs as ah,H as ai,tn as b,ds as c,A as d,T as e,en as f,nn as g,ps as h,G as i,hs as j,gs as k,U as l,is as m,an as n,v as o,rn as p,ms as q,ln as r,Is as s,ws as t,xs as u,ks as v,hn as w,dn as x,bs as y,ys as z};
