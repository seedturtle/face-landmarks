import{au as zn,O as $n,dE as ke,dG as Pn,ho as En,eQ as Ln,dD as Bn,fi as Yt,dd as Gn,dm as Ne,cF as it,fB as xe,hr as qn,g5 as _n,a4 as ve,ax as Un,gx as j,es as Ct,b3 as jn,bc as we,bd as Te,be as Xn,eE as Yn,ch as ct,B as Kn,ci as Me,d2 as K,c4 as Zn,a as Fe,b as Re,d as Jn,e as Qn,fM as ut,e2 as It,e8 as kt,cj as Tt,cY as Nt,fa as vt,dM as At,f as ts,g as es,h as ns,i as De,j as Ve,k as We,l as He,m as Ae,n as ss,dA as ae,d0 as Gt,ce as oe,o as as,d1 as Kt,p as os,q as rs,ah as is,r as cs,eb as Oe,e9 as ze,ec as $e,ee as ls,ef as ds,s as ps,u as us,w as Pe,y as hs,aq as fs,z as ms,ck as gs,cZ as ee,D as Is,de as re,cT as Ot,bW as lt,E as ks,F as xs,G as bs,cU as ie,H as Ss,I as ys,J as Ee,K as Le,L as Cs,M as Ns,hk as Zt,f8 as vs,et as Be,N as ws,P as Ts,Q as Ms,R as Fs,S as Rs,T as Ds,U as Vs,V as Ws,cV as ce,e1 as le,eX as Et,hd as de,W as be,hb as Dt,f9 as Ge,X as Se,Y as Hs,bS as As,a3 as Os,dl as zs,cK as $s,e5 as Ps,e6 as Es,eJ as Ls,a5 as Bs,a7 as qe,a1 as Gs,a0 as qs,$ as _s,_ as Us,Z as js,a2 as Xs,a9 as Ys,ba as _e,e4 as Ue,di as je,gM as Ks,cR as Zs,cS as Js,dP as Qs,cn as ta,dO as ea,ab as na,ac as sa,eD as aa,ad as oa,ai as ra,aj as ia,ak as ca,fR as la,al as da,cO as pa,ao as ua,ar as Xe,as as Ye,at as Ke,aA as ha,aC as Ze,aD as Je,aE as Qe,aF as tn,av as fa,aw as ma,aG as ga,aH as Ia,aI as ka,aJ as xa,aK as ba,aL as Sa,aN as ya,aO as Ca,aQ as Na,eC as en,aR as nn,bz as va,aS as wa,gn as Ta,aV as Ma,fw as Fa,aW as Ra,fx as Da,aX as Va,fy as Wa,a_ as Ha,c3 as Aa,a$ as Oa,b0 as za,cm as $a,b1 as Pa,b2 as sn,b5 as Ea,b6 as La,b7 as Ba,b8 as Ga,bb as an,bf as qa,bg as _a,bh as Ua,bi as ja,bj as Xa,bk as Ya,e7 as Ka,bl as on,bq as Za,cH as pe,br as Ja,bs as Qa,bt as rn,bo as to,bp as eo,bv as cn,bw as ln,bx as dn,bA as pn,bB as no,bC as so,bD as ao,bE as oo,bF as ro,bG as io,bH as co,fS as lo,bJ as po,bM as un,bN as uo,gE as ho,c_ as fo,bO as mo,bP as go,bQ as Io,bT as hn,bU as fn,bX as ko,bY as xo,bZ as bo,b_ as So,cL as ue,c0 as yo,c1 as Co,c2 as No,g6 as vo}from"./index--wnlGcJ8.js";import{d as q,ag as Q,o as Mt,A as Ft,X as wo,b as Lt,ad as pt,e as zt,Z as Vt,f as mn,S as Bt,l as ft,n as To,g as Mo,i as he,ai as Fo,J as fe,a9 as gn,w as Ro,x as Do,E as Vo,af as Wo,G as Ho,r as Ao,O as Oo,P as zo,Q as $o,R as Po,V as Rt,$ as Eo,a0 as Lo,a1 as In,a5 as Bo,a6 as Go,a7 as qo,a8 as _o,ab as Uo,ac as jo,ah as Xo,p as Yo,a as Ko,c as Zo,h as Jo,j as Qo,k as tr,m as er,q as nr,s as sr,t as ar,u as or,v as rr,y as ir,z as cr,B as lr,C as dr,D as pr,F as ur,H as hr,I as fr,K as mr,L as gr,M as Ir,N as kr,T as xr,U as br,Y as Sr,_ as yr,a2 as Cr,a3 as Nr,a4 as vr,aa as wr,ae as Tr}from"./shared-o8RQ9Vii.js";import{W as Zp}from"./shared-o8RQ9Vii.js";import"./index-D5YqzolL.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function nt(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{shape:s}=n,l=j(e.shape),c=Yn(s,l),d=j(c);ct(l===d,()=>`The new shape (${c}) has ${d} elements and the old shape (${e.shape}) has ${l} elements. The new shape and old shape must have the same number of elements.`),t.incRef(e.dataId);const i=t.data.get(e.dataId);if(i.complexTensorInfos!=null){const r=i.complexTensorInfos.real,u=i.complexTensorInfos.imag;r.shape=c,u.shape=c}return{dataId:e.dataId,shape:c,dtype:e.dtype}}const Ar={kernelName:Xn,backendName:"cpu",kernelFunc:nt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yr(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{axis:s}=n;q(e,"argMax");let l=ut(s,e.shape);const c=It(l,e.shape.length);let d=e;const i=[];c!=null&&(d=pt({inputs:{x:e},backend:t,attrs:{perm:c}}),i.push(d),l=kt(l.length,d.shape.length)),l=[l[0]],Tt("argMax",l,d.shape.length);const[r,u]=Nt(d.shape,l),p=j(r),h=vt(p,"int32"),m=j(u),f=t.data.get(d.dataId).values;for(let g=0;g<h.length;++g){const I=g*m;let x=f[I],b=0;for(let k=0;k<m;++k){const S=f[I+k];S>x&&(x=S,b=k)}h[g]=b}return i.forEach(g=>t.disposeIntermediateTensorInfo(g)),t.makeTensorInfo(r,"int32",h)}const Kr={kernelName:es,backendName:"cpu",kernelFunc:Yr};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ei(o){const{inputs:a,backend:t,attrs:n}=o,{x:e,dy:s}=a,{strides:l,pad:c,filterShape:d}=n;q([e,s],"conv3dBackpropFilterV2");const i=K(e.shape),r=K(s.shape),u=ie(e.shape,d,l,1,c),p=u.strideDepth,h=u.strideHeight,m=u.strideWidth,f=u.filterDepth,g=u.filterHeight,I=u.filterWidth,x=new lt(u.filterShape,"float32"),b=x.values,[k,S,y,C]=x.strides,M=t.data.get(s.dataId).values,[V,R,H,A]=r,N=t.data.get(e.dataId).values,[F,v,w,W]=i,T=u.padInfo.front,D=u.padInfo.left,z=u.padInfo.top;for(let O=0;O<f;++O){const E=Math.max(0,Math.ceil((T-O)/p)),$=Math.min(u.outDepth,(u.inDepth+T-O)/p),L=O*k;for(let P=0;P<g;++P){const B=Math.max(0,Math.ceil((z-P)/h)),G=Math.min(u.outHeight,(u.inHeight+z-P)/h),U=P*S+L;for(let _=0;_<I;++_){const X=Math.max(0,Math.ceil((D-_)/m)),Y=Math.min(u.outWidth,(u.inWidth+D-_)/m),Z=_*y+U;for(let tt=0;tt<u.inChannels;++tt){const ot=tt*C+Z;for(let et=0;et<u.outChannels;++et){let J=0;for(let at=0;at<u.batchSize;++at){const st=at*F,mt=at*V;for(let rt=E;rt<$;++rt){const dt=(O+rt*p-T)*v+st,wt=rt*R+mt;for(let ht=B;ht<G;++ht){const bt=(P+ht*h-z)*w+dt,St=ht*H+wt;for(let yt=X;yt<Y;++yt){const Qt=(_+yt*m-D)*W+bt,te=yt*A+St;J+=N[Qt+tt]*M[te+et]}}}}b[ot+et]=J}}}}}return t.makeTensorInfo(x.shape,x.dtype,x.values)}const Li={kernelName:Ss,backendName:"cpu",kernelFunc:Ei};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Sc=Xs,yc=js,Cc=Us,Nc=_s,vc=qs,wc=Gs,Tc=Q(qe,o=>{const a=Math.sign(o),t=Math.abs(o),n=1/(1+Sc*t);return a*(1-((((wc*n+vc)*n+Nc)*n+Cc)*n+yc)*n*Math.exp(-t*t))}),Mc={kernelName:qe,backendName:"cpu",kernelFunc:Tc};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jt(o){const{inputs:a,backend:t,attrs:n}=o,{input:e}=a,{dim:s}=n,l=e.shape.length,c=e.shape.slice();let d=s;return s<0&&(ct(-(l+1)<=s,()=>`Axis must be in the interval [${-(l+1)}, ${l}]`),d=l+s+1),c.splice(d,0,1),nt({inputs:{x:e},backend:t,attrs:{shape:c}})}const Fc={kernelName:Ys,backendName:"cpu",kernelFunc:jt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mn(o,a,t){const n=o.shape,e=n[0],s=n[1],l=t.data.get(o.dataId),c=l.complexTensorInfos.real,d=l.complexTensorInfos.imag,i=[e,s],r=j(i),u=Ct("float32",r),p=Ct("float32",r);for(let g=0;g<e;g++){const I=Vt({inputs:{x:c},backend:t,attrs:{begin:[g,0],size:[1,s]}}),x=Vt({inputs:{x:d},backend:t,attrs:{begin:[g,0],size:[1,s]}}),b=ft({inputs:{real:I,imag:x},backend:t}),{real:k,imag:S}=Dc(b,a,t),y=Yt(k,S);for(let C=0;C<s;C++){const M=Ue(y,C);u[g*s+C]=M.real,p[g*s+C]=M.imag}t.disposeIntermediateTensorInfo(I),t.disposeIntermediateTensorInfo(x),t.disposeIntermediateTensorInfo(b)}const h=t.makeTensorInfo(i,"float32",u),m=t.makeTensorInfo(i,"float32",p),f=ft({inputs:{real:h,imag:m},backend:t});return t.disposeIntermediateTensorInfo(h),t.disposeIntermediateTensorInfo(m),f}function Dc(o,a,t){const n=j(o.shape),e=t.data.get(o.dataId),s=t.data.get(e.complexTensorInfos.real.dataId).values,l=t.data.get(e.complexTensorInfos.imag.dataId).values;if(Vc(n)){const c=se(s,l,n,a,t),d=[o.shape[0],o.shape[1]];if(a){const i=t.makeTensorInfo(d,"float32",c.real),r=t.makeTensorInfo(d,"float32",c.imag),u=t.makeTensorInfo([],"float32",je(n,"float32")),p=Ft({inputs:{x:u},backend:t}),h=ne.kernelFunc({inputs:{a:i,b:u},backend:t}),m=ne.kernelFunc({inputs:{a:r,b:p},backend:t}),f=t.data.get(h.dataId).values,g=t.data.get(m.dataId).values;return t.disposeIntermediateTensorInfo(i),t.disposeIntermediateTensorInfo(r),t.disposeIntermediateTensorInfo(u),t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(h),t.disposeIntermediateTensorInfo(m),{real:f,imag:g}}return c}else{const c=Yt(s,l),d=Wc(c,n,a);return Ks(d)}}function Vc(o){return(o&o-1)===0}function se(o,a,t,n,e){if(t===1)return{real:o,imag:a};const s=Yt(o,a),l=t/2,c=Zs(s),d=c.real,i=c.imag,r=[d.length],u=e.makeTensorInfo(r,"float32",d),p=e.makeTensorInfo(r,"float32",i),h=ft({inputs:{real:u,imag:p},backend:e}),m=Js(s),f=m.real,g=m.imag,I=[f.length],x=e.makeTensorInfo(I,"float32",f),b=e.makeTensorInfo(I,"float32",g),k=ft({inputs:{real:x,imag:b},backend:e}),S=se(d,i,l,n,e),y=S.real,C=S.imag,M=[y.length],V=e.makeTensorInfo(M,"float32",y),R=e.makeTensorInfo(M,"float32",C),H=ft({inputs:{real:V,imag:R},backend:e}),A=se(f,g,l,n,e),N=A.real,F=A.imag,v=[N.length],w=e.makeTensorInfo(v,"float32",N),W=e.makeTensorInfo(v,"float32",F),T=ft({inputs:{real:w,imag:W},backend:e}),D=Qs(t,n),z=[D.real.length],O=e.makeTensorInfo(z,"float32",D.real),E=e.makeTensorInfo(z,"float32",D.imag),$=ft({inputs:{real:O,imag:E},backend:e}),L=fe({inputs:{a:$,b:T},backend:e}),P=Lt({inputs:{a:H,b:L},backend:e}),B=gn({inputs:{a:H,b:L},backend:e}),G=Bt({inputs:{input:P},backend:e}),U=Bt({inputs:{input:B},backend:e}),_=Wt({inputs:{input:P},backend:e}),X=Wt({inputs:{input:B},backend:e}),Y=Ht({inputs:[G,U],backend:e,attrs:{axis:0}}),Z=Ht({inputs:[_,X],backend:e,attrs:{axis:0}}),tt=e.data.get(Y.dataId).values,ot=e.data.get(Z.dataId).values;return e.disposeIntermediateTensorInfo(u),e.disposeIntermediateTensorInfo(p),e.disposeIntermediateTensorInfo(h),e.disposeIntermediateTensorInfo(x),e.disposeIntermediateTensorInfo(b),e.disposeIntermediateTensorInfo(k),e.disposeIntermediateTensorInfo(V),e.disposeIntermediateTensorInfo(R),e.disposeIntermediateTensorInfo(H),e.disposeIntermediateTensorInfo(w),e.disposeIntermediateTensorInfo(W),e.disposeIntermediateTensorInfo(T),e.disposeIntermediateTensorInfo(O),e.disposeIntermediateTensorInfo(E),e.disposeIntermediateTensorInfo($),e.disposeIntermediateTensorInfo(L),e.disposeIntermediateTensorInfo(P),e.disposeIntermediateTensorInfo(B),e.disposeIntermediateTensorInfo(G),e.disposeIntermediateTensorInfo(_),e.disposeIntermediateTensorInfo(U),e.disposeIntermediateTensorInfo(X),e.disposeIntermediateTensorInfo(Y),e.disposeIntermediateTensorInfo(Z),{real:tt,imag:ot}}function Wc(o,a,t){const n=new Float32Array(a*2);for(let e=0;e<a;e++){let s=0,l=0;for(let c=0;c<a;c++){const d=ea(e*c,a,t),i=Ue(o,c);s+=i.real*d.real-i.imag*d.imag,l+=i.real*d.imag+i.imag*d.real}t&&(s/=a,l/=a),ta(n,s,l,e)}return n}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _c(o){const{inputs:a,backend:t,attrs:n}=o,{x:e,indices:s}=a,{axis:l,batchDims:c}=n;q([e,s],"gatherV2");const d=ut(l,e.shape)[0],i=t.data.get(s.dataId).values,r=e.shape[d];for(let k=0;k<i.length;++k){const S=i[k];ct(S<=r-1&&S>=0,()=>`GatherV2: the index value ${S} is not in [0, ${r-1}]`)}let u=c;c==null&&(u=0);const p=j(s.shape),h=pa(e,s,d,u),m=nt({inputs:{x:e},backend:t,attrs:{shape:[h.batchSize,h.outerSize,h.dimSize,h.sliceSize]}}),f=nt({inputs:{x:s},backend:t,attrs:{shape:[h.batchSize,p/h.batchSize]}}),g=[h.batchSize,h.outerSize,p/h.batchSize,h.sliceSize],I=t.bufferSync(f),x=t.bufferSync(m),b=Do(x,I,g);return t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(f),t.makeTensorInfo(h.outputShape,b.dtype,b.values)}const Uc={kernelName:da,backendName:"cpu",kernelFunc:_c};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Yc=Q(Xe,o=>Number.isFinite(o)?1:0,"bool"),Kc={kernelName:Xe,backendName:"cpu",kernelFunc:Yc};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Zc=Q(Ye,o=>Math.abs(o)===1/0?1:0,"bool"),Jc={kernelName:Ye,backendName:"cpu",kernelFunc:Zc};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function el(o){const{backend:a,attrs:t}=o,{start:n,stop:e,num:s}=t,l=Vo(n,e,s);return a.makeTensorInfo([l.length],"float32",l)}const nl={kernelName:ha,backendName:"cpu",kernelFunc:el};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Fn(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{reductionIndices:s,keepDims:l}=n,c=t;let d=e.shape;const i=d.length,r=ut(s,d);let u=r;const p=It(u,i);let h=c.data.get(e.dataId).values;if(p!=null){const k=new Array(i);for(let S=0;S<k.length;S++)k[S]=d[p[S]];h=Wo(h,d,e.dtype,p,k),u=kt(u.length,i),d=k}q(e,"max"),Tt("max",u,i);const[m,f]=Nt(d,u),g=j(f),I=Ho(h,g,m,e.dtype),x=c.write(I,m,e.dtype);let b=m;return l&&(b=At(m,r)),{dataId:x,shape:b,dtype:e.dtype}}const Il={kernelName:ga,backendName:"cpu",kernelFunc:Fn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Rn(o){const{inputs:a,backend:t,attrs:n}=o,{logits:e}=a,{dim:s}=n,l=e.shape.length;let c=s;if(c===-1&&(c=l-1),c!==l-1)throw Error(`Softmax along a non-last dimension is not yet supported. Logits was rank ${l} and dim was ${c}`);const d=ut([c],e.shape),i=Fn({inputs:{x:e},backend:t,attrs:{reductionIndices:d,keepDims:!1}}),r=At(i.shape,d),u=nt({inputs:{x:i},backend:t,attrs:{shape:r}}),p=gn({inputs:{a:e,b:u},backend:t}),h=Ao({inputs:{x:p},backend:t}),m=qt({inputs:{x:h},backend:t,attrs:{axis:d,keepDims:!1}}),f=nt({inputs:{x:m},backend:t,attrs:{shape:r}}),g=ge({inputs:{a:h,b:f},backend:t});return t.disposeIntermediateTensorInfo(i),t.disposeIntermediateTensorInfo(u),t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(h),t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(f),g}const zl={kernelName:va,backendName:"cpu",kernelFunc:Rn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xt(o){const{inputs:a,backend:t}=o,{x:n}=a;if(n.dtype==="string")throw new Error("zerosLike is not supported for string tensors");if(n.dtype==="complex64"){const e=Bt({inputs:{input:n},backend:t}),s=Xt({inputs:{x:e},backend:t}),l=Wt({inputs:{input:n},backend:t}),c=Xt({inputs:{x:l},backend:t}),d=ft({inputs:{real:s,imag:c},backend:t});return t.disposeIntermediateTensorInfo(e),t.disposeIntermediateTensorInfo(s),t.disposeIntermediateTensorInfo(l),t.disposeIntermediateTensorInfo(c),d}else return Ie({backend:t,attrs:{shape:n.shape,value:0,dtype:n.dtype}})}const Zl={kernelName:Aa,backendName:"cpu",kernelFunc:Xt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Dn(o){const{inputs:a,backend:t}=o,{x:n}=a;if(n.dtype==="string")throw new Error("onesLike is not supported for string tensors");if(n.dtype==="complex64"){const e=Bt({inputs:{input:n},backend:t}),s=Dn({inputs:{x:e},backend:t}),l=Wt({inputs:{input:n},backend:t}),c=Xt({inputs:{x:l},backend:t}),d=ft({inputs:{real:s,imag:c},backend:t});return t.disposeIntermediateTensorInfo(e),t.disposeIntermediateTensorInfo(s),t.disposeIntermediateTensorInfo(l),t.disposeIntermediateTensorInfo(c),d}else return Ie({backend:t,attrs:{shape:n.shape,value:1,dtype:n.dtype}})}const Jl={kernelName:Oa,backendName:"cpu",kernelFunc:Dn};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ud=11920928955078125e-23,ye=Math.log(Ud)+2,jd=Q(pn,o=>{const a=o>-ye,t=o<ye,n=Math.exp(o);let e;return t?e=n:a?e=o:e=Math.log(1+n),e}),Xd={kernelName:pn,backendName:"cpu",kernelFunc:jd};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yd(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{blockShape:s,paddings:l}=n;q([e],"spaceToBatchND");const c=j(s),d=[[0,0]];d.push(...l);for(let y=1+s.length;y<e.shape.length;++y)d.push([0,0]);const i=Wn.kernelFunc({inputs:{x:e},backend:t,attrs:{paddings:d,constantValue:0}}),r=Oe(i.shape,s,c,!1),u=ze(r.length,s.length,!1),p=$e(i.shape,s,c,!1),f=nt({inputs:{x:i},backend:t,attrs:{shape:r}}),x=pt({inputs:{x:f},backend:t,attrs:{perm:u}}),S=nt({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(i),t.disposeIntermediateTensorInfo(f),t.disposeIntermediateTensorInfo(x),S}const Kd={kernelName:no,backendName:"cpu",kernelFunc:Yd};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ip(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{numOrSizeSplits:s,axis:l}=n,c=ut(l,e.shape)[0],d=lo(e,s,c),i=new Array(e.shape.length).fill(0),r=e.shape.slice();return d.map(u=>{const p=[...r];p[c]=u;const h=Vt({inputs:{x:e},backend:t,attrs:{begin:i,size:p}});return i[c]+=u,h})}const cp={kernelName:co,backendName:"cpu",kernelFunc:ip};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function up(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{begin:s,end:l,strides:c,beginMask:d,endMask:i,ellipsisMask:r,newAxisMask:u,shrinkAxisMask:p}=n;q(e,"stridedSlice");const{finalShapeSparse:h,finalShape:m,isIdentity:f,sliceDim0:g,isSimpleSlice:I,begin:x,end:b,strides:k}=ho(e.shape,s,l,c,d,i,r,u,p);let S;if(f)S=nt({inputs:{x:e},backend:t,attrs:{shape:m}});else if(g||I){ct(e.shape.length>=1,()=>`Input must have rank at least 1, got: ${e.shape.length}`);const y=fo(x,b,k),C=Vt({inputs:{x:e},backend:t,attrs:{begin:x,size:y}});S=nt({inputs:{x:C},backend:t,attrs:{shape:m}}),t.disposeIntermediateTensorInfo(C)}else{const y=t.bufferSync(e),C=Bo(h,y,k,x);S=t.makeTensorInfo(m,C.dtype,C.values)}return S}const hp={kernelName:uo,backendName:"cpu",kernelFunc:up};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wp(o){const{inputs:a,backend:t,attrs:n}=o,{x:e}=a,{reps:s}=n;q(e,"tile");const l=Uo(t.bufferSync(e),s);return t.makeTensorInfo(l.shape,l.dtype,l.values)}const Tp={kernelName:xo,backendName:"cpu",kernelFunc:wp};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $p(o){const{inputs:a,attrs:t,backend:n}=o,{axis:e}=t,{x:s}=a;q(s,"unique");const l=n.data.get(s.dataId).values,{outputValues:c,outputShape:d,indices:i}=Xo(l,e,s.shape,s.dtype);return[n.makeTensorInfo(d,s.dtype,c),n.makeTensorInfo([i.length],"int32",i)]}const Pp={kernelName:yo,backendName:"cpu",kernelFunc:$p};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ep(o){const{inputs:a,backend:t,attrs:n}=o,{value:e}=a;let{axis:s}=n;s<0&&(s+=e.shape.length);const l=e.shape.length,c=e.shape[s],d=new Array(l-1);let i=0;for(let h=0;h<l;h++)h!==s&&(d[i++]=e.shape[h]);const r=new Array(l).fill(0),u=e.shape.slice();u[s]=1;const p=new Array(c);for(let h=0;h<p.length;h++){r[s]=h;const m=Vt({inputs:{x:e},backend:t,attrs:{begin:r,size:u}});p[h]=nt({inputs:{x:m},backend:t,attrs:{shape:d}}),t.disposeIntermediateTensorInfo(m)}return p}const Lp={kernelName:Co,backendName:"cpu",kernelFunc:Ep};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bp(o){const{inputs:a,backend:t,attrs:n}=o,{x:e,segmentIds:s}=a,{numSegments:l}=n;q(e,"unsortedSegmentSum");const c=e.shape.length,d=s.shape.length,i=[],r=[],u=c-d;let p=s;for(let m=0;m<u;++m){const f=jt({inputs:{input:p},backend:t,attrs:{dim:m+1}});p=f,r.push(f)}for(let m=0;m<l;++m){const f=je(m,"int32"),g=t.makeTensorInfo([],"int32",f),I=Yo({inputs:{a:g,b:p},backend:t}),x=he({inputs:{x:I},backend:t,attrs:{dtype:"float32"}}),b=fe({inputs:{a:x,b:e},backend:t}),k=qt({inputs:{x:b},backend:t,attrs:{axis:0,keepDims:!1}});i.push(k),r.push(g),r.push(I),r.push(x),r.push(b),r.push(k)}const h=Vn({inputs:i,backend:t,attrs:{axis:0}});return r.forEach(m=>t.disposeIntermediateTensorInfo(m)),h}const Gp={kernelName:No,backendName:"cpu",kernelFunc:Bp};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const qp=[$r,Ko,Er,Br,Zo,qr,Ur,Xr,Kr,Jr,ti,ni,ai,ii,li,ui,fi,gi,ki,Or,bi,yi,Ni,Jo,wi,Qo,tr,Mi,er,Ri,Vi,Wi,Ai,zi,Pi,Li,Gi,_i,ji,Yi,Zi,Qi,ec,sc,ac,rc,cc,dc,pc,uc,hc,mc,kc,Fr,bc,nr,Mc,sr,Fc,ar,Ac,Oc,$c,or,rr,Ec,Bc,qc,Uc,ir,cr,lr,Xc,Di,Kc,Jc,tl,Rr,dr,pr,nl,ur,al,il,ll,ul,fl,gl,Il,hr,xl,Sl,Cl,vl,Tl,Fl,Dl,fr,Wl,Ol,Pl,mr,gr,Bl,_l,Xl,Ir,Kl,Jl,Ql,Wn,sd,Vr,kr,od,id,ld,pd,xr,ne,hd,Wr,Hr,Ar,md,Id,xd,Sd,Cd,Nd,wd,br,Md,Wd,Ad,Pd,Sr,Ld,Gd,_d,yr,zl,Xd,Kd,Jd,tp,np,ap,rp,cp,Cr,lp,Nr,vr,pp,hp,mp,Ip,xp,wr,gc,Sp,Cp,vp,Tp,Fp,Dp,Tr,Pp,Lp,Gp,Zl];for(const o of qp)vo(o);export{Jt as MathBackendCPU,Zp as shared,Xp as version_cpu};
